...
class ProfileScreen extends StatelessWidget{
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ProfileCubit, ProfileState>(builder: (context, state){
      return SiumBaseScreen(body: SafeArea(
        child: Column(
          children: [
            Expanded(
              child: SingleChildScrollView(
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ProfileTextItem(title: "Username", value: state.user?.displayName ?? ""),
                      ProfileTextItem(title: "Email", value: state.user?.email ?? ""),
                      ProfilePasswordItem()
                    ],
                  ),
                ),
            ...
            const SiumButton(color: Colors.red, text: "Logout")
          ],
        ),
      ), title: "Profilo", loading: state.isLoading);
    });
  }
