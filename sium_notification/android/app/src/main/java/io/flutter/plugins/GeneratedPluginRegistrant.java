...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    try {
      flutterEngine.getPlugins().add(new org.demen.androidpowermanager.AndroidPowerManagerPlugin());
    } catch(Exception e) {
      Log.e(TAG, "Error registering plugin android_power_manager, org.demen.androidpowermanager.AndroidPowerManagerPlugin", e);
    }
    try {
